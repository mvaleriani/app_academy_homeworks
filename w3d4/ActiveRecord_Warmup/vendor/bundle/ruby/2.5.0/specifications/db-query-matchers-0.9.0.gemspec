...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activesupport>.freeze, ["<= 6.0", ">= 4.0"])
      s.add_runtime_dependency(%q<rspec>.freeze, ["~> 3.0"])
      s.add_development_dependency(%q<activerecord>.freeze, ["<= 6.0", ">= 4.0"])
      s.add_development_dependency(%q<sqlite3>.freeze, [">= 0"])
      s.add_development_dependency(%q<appraisal>.freeze, ["~> 2.0"])
    else
      s.add_dependency(%q<activesupport>.freeze, ["<= 6.0", ">= 4.0"])
      s.add_dependency(%q<rspec>.freeze, ["~> 3.0"])
      s.add_dependency(%q<activerecord>.freeze, ["<= 6.0", ">= 4.0"])
